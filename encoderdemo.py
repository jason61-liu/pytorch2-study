...
class PoetryModel(nn.Module):
    def __init__(self,vocab_size,num_encoder_layer=4,emb_size=512,dim_feedforward=1024,dropout=0.1):
        super().__init__()
        ...
        self.transformer_encoder=TransformerEncoder(encoder_layer,num_layers=num_encoder_layer)
