...
class ResNet(nn.Module):
    def __init__(self, block, num_block, num_classes=100):
        ...
        self.conv3_x = self.__make_layer(block, 128, num_block[1], 2)
        self.conv4_x = self.__make_layer(block, 256, num_block[2], 2)
        self.conv5_x = self.__make_layer(block, 512, num_block[3], 2)
